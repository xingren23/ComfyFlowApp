...
class MyAppModel:
    ...
    def _init_table(self):
        ...
        with self.session as s:
            sql = text(f'CREATE TABLE IF NOT EXISTS {self.app_talbe_name} (id TEXT PRIMARY KEY, name TEXT, description TEXT, image TEXT, app_conf TEXT, api_conf TEXT, template TEXT, url TEXT, status TEXT, created_at TEXT, updated_at TEXT);')
            s.execute(sql)
